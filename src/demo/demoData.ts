...
export function createSeedData(): DemoDataset {
  ...
  const family: Family = {
    id: DEMO_FAMILY_ID,
    name: 'Meine Familie',
    image_url: coverImage('Meine Familie'),
  ...
  return {
    ...
    tributes,
    audios,
    // Öffentliche Beta: „leere App"-Gefühl – keine vorgetäuschte Aktivität
    // fremder Personen. Familienbaum-Platzhalter (persons) bleiben.
    capsules: [],
    recipients: [],
    activities: [],
    statuses: [],
